...
function out=SSDScoreLD(data) % Import "data" from user.
...
actu = cumsum(generateLD(m,max(data)));                      % the array "actu" is the cumulative Luria-Delbruck distribtuion with parameter "m".
out=actu;
